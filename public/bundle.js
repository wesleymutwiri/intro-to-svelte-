var app = (function () {
    ...
    /* User.svelte generated by Svelte v3.12.1 */

    const file = "User.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "src", ctx.avatar);
    			attr_dev(img, "alt", img_alt_value = "" + ctx.username + "'s Avatar");
    			add_location(img, file, 6, 0, 79);
    			add_location(h3, file, 7, 0, 127);
    ...
    class User extends SvelteComponentDev {
    	constructor(options) {
    		...
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "User", options, id: create_fragment.name });
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$1, 23, 0, 342);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block.name, type: "if", source: "(23:0) {#if users}", ctx });
    	return block;
    }

    // (25:0) {#each users as user}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			user.$$.fragment.c();
    			t = space();
    			add_location(li, file$1, 25, 0, 369);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_each_block.name, type: "each", source: "(25:0) {#each users as user}", ctx });
    	return block;
    }

    function create_fragment$1(ctx) {
    	var main, h1, t1, t2, t3, current;

    	var if_block = (ctx.users) && create_if_block(ctx);

    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "This is something";
    			t1 = space();
    			if (if_block) if_block.c();
    			t2 = space();
    			t3 = text(ctx.users);
    			add_location(h1, file$1, 21, 2, 302);
    			add_location(main, file$1, 20, 0, 293);
    		},
    		...
    		p: function update(changed, ctx) {
    			...
    			if (!current || changed.users) {
    				set_data_dev(t3, ctx.users);
    			}
    		},
    ...
    function getGithubUsers() {
      ...
      .then(resp => resp.json())
      .then(data => ($$invalidate('users', users = data)));
    }
